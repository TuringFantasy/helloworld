        ...
        stage('Deploy') {
            ...
            steps {
                script {
                    ...
                    sh "sleep 5s"
                    sh "export PYTHONIOENCODING=UTF-8; ${macawPublishCmd} webapp --tag ${dockerImageTag} --name helloworld-webapp --version 1.0.0 --file  ${serviceHome}/webapp/target/helloworld.war --skip"
                }
            }
        }
